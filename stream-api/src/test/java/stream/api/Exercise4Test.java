...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void isThereAnyoneOlderThan40() {
        ...
        boolean olderThan40Exists1 = customerList.stream()
                .filter(c -> c.getAge() > 40).count() > 0;

        boolean olderThan40Exists2 = customerList.stream()
                .filter(c -> c.getAge() > 40).findFirst().isPresent();
