...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
//        Comparator<Integer> descOrder = Comparator.comparingInt((Integer x) -> x).reversed();
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<Customer> sorted = customerList.stream()
                .sorted((c1, c2) -> c2.getBudget() - c1.getBudget());
        Stream<String> top3RichCustomerStream = sorted.limit(3).map(c -> c.getName());
